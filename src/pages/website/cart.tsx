...
const Cartpage = () => {
    ...
    //         const { data } = await instance.post("/cart/increase", { userId, productId });
    //         return data;
    //     },
    //     onSuccess: () => {
    ...
    //     mutationFn: async (productId) => {
    //         const { data } = await instance.post("/cart/decrease", { userId, productId });
    //         return data;
    //     },
    //     onSuccess: () => {
    //         queryClient.invalidateQueries({
    ...
    //         if (confirm) {
    //             const { data } = await instance.post("/cart/remove", { userId, productId });
    //             return data;
    //         }
    //     },
    //     onSuccess: () => {
